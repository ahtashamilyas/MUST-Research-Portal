...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $newfaculty = $_POST['new_faculty'];

    // Update the user's city in the database
    $sql = "UPDATE repos_data SET faculty = '$newfaculty' WHERE id = '$userId'";
...
<html>
<head>
    <title>Manage Faculty - Admin Panel - MUST Researchers</title>
    <style>
       table {
  /* max-width: 500px; */
  position: relative;
...
<body>
    ...
    $sql1 = " SELECT ID, author, faculty FROM repos_data";
    $result1 = $conn1->query($sql1);
    if($result1->num_rows > 0){
        echo "<h1>Show All faculty!</h1>";
        echo "<table>
        <tr>
            <th>ID:</th>
            <th>Author:</th>
