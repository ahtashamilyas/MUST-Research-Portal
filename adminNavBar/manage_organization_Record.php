...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE repos_data SET organization = '$new_organization' WHERE id = '$userId'";
...
<html>
<head>
    <title>Manage Organization Record - Admin Panel - MUST Researchers</title>
    <style>
        table {
  /* max-width: 500px; */
  position: relative;
...
<body>
    ...
    <div class="content">
        ...
        <form method="POST" action= "manage_organization_Record.php">
            <label for="user_id">User ID:</label>
            <input type="text" id="user_id" name="user_id" required>

            <label for="new_organization">New Organization:</label>
    ...
    $sql1 = " SELECT ID, author, organization FROM repos_data";
    $result1 = $conn1->query($sql1);
    if($result1->num_rows > 0){
        echo "<h1>Show All Organizations!</h1>";
        echo "<table>
        <tr>
            <th>ID:</th>
            <th>Author:</th>
